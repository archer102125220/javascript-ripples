...
style.innerText = '.jquery-ripples { position: relative; z-index: 0; }';
...
const Ripples = function (el, options) {
  ...
  this.$el.classList.add('jquery-ripples');
...
Ripples.prototype = {
  ...
  computeTextureBoundaries: function () {
    ...
    var elementOffset = { top: this.$el.offsetTop, left: this.$el.offsetLeft };
...
function ripples(targetId, option, ...arguments) {
  ...
  if (!data) {
    ...
    Ripples.prototype[option].apply(data, arguments);
  }
}